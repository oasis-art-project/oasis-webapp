    ...
    <div className="">
      ...
      <StyledDialog isOpen={showDialogHubs} onDismiss={closeHubsDialog} aria-label="Hubs intro">
        ...
        <div className="relative text-center">
          ...
          <p className="mt-6 mb-12 text-xl font-header">
          <b>2)</b> After joining, use the <b>W KEY</b> to move forward, <b>S KEY</b> to move backwards, and <b>mouse pointer</b> to set direction.
          </p>
          <p className="mt-6 mb-12 text-xl font-header">
          <b>3)</b> If you are using a phone, <b>PINCH IN/OUT</b> to move foward/backwards, and <b>move the phone</b> around to set direction.
          </p>          
