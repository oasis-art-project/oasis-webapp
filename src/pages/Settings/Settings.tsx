...
import useUserProfile, { updateProfile, updateProfilePic } from '../../hooks/useUpdateProfile';
...
function Settings() {
  ...
  return (
    <>
      <ProfileImage user={userFromRequest} picMutation={handlePicSubmit} />
      <ProfileInfo user={userFromRequest} email={user.email} mutation={handleInfoSubmit} />
    </>
  );
}
