...
export const FETCH_ARTWORK_EVENTS_SUCCESS = 'FETCH_ARTWORK_EVENTS_SUCCESS';
export const FETCH_ARTWORK_EVENTS_ERROR = 'FETCH_ARTWORK_EVENTS_ERROR';
...
// one host
export const SET_CURRENT_HOST = 'SET_CURRENT_HOST'
export const FETCH_HOST = 'FETCH_HOST';
export const FETCH_HOST_SUCCESS = 'FETCH_HOST_SUCCESS';
export const FETCH_HOST_ERROR = 'FETCH_HOST_ERROR';

// places from host
export const FETCH_HOST_PLACES = 'FETCH_HOST_PLACES';
export const FETCH_HOST_PLACES_SUCCESS = 'FETCH_HOST_PLACES_SUCCESS';
export const FETCH_HOST_PLACES_ERROR = 'FETCH_HOST_PLACES_ERROR';
